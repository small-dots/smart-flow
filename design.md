...
| Micro | Inter Variable | 12px (0.69rem) | 510 | 1.40 | normal | Tiny labels |
...
### Spacing System
- Base unit: 8px
- Scale: 1px, 4px, 7px, 8px, 12px, 12px, 16px, 19px, 20px, 22px, 24px, 28px, 32px, 35px
- The 7px and 12px values suggest micro-adjustments for optical alignment
